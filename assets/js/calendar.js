...
w: "Пн</td><td>Вт</td><td>Ср</td><td>Чт</td><td>Пт</td><td>Сб</td><td>Вс"
	...
	"lv": {
		x: "Aizvērt", nex: "Nakošais mēnesīs", pre: "Iepriekšējs mēnesīs", clear: "Notirīt",
		m: ["Jan","Feb","Mar","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dec"],
		mo: ["Janvāris","Ferbruāris","Marts","Aprīlis","Maijs","Jūnijs","Jūlijs","Augusts","Septembris","Oktobris","Novembris","Decembris"],
		w: "P</td><td>O</td><td>T</td><td>C</td><td>P</td><td>S</td><td>Sv"
			},
}
var def = {
	lang: "lv", // en/ru
...
if(DNlast>0) {// › &rarr;
	...
	if(DNlast<6) {
		ca += '<td colspan='+(7-DNlast)+' class="cal-r" align=center title="'+lang[a.lang].nex+' '+lang[a.lang].mo[mm]+'"><b>'+lang[a.lang].m[mm]+' ›</b></td>';
