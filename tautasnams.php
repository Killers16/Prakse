								...
								<div class="main__inner">
									...
									<div class="main-image main-image--cropped main-image--parallax">
										<p class="main-image__inner" style="background-image: url( 'content/klubi11.jpg' );">
											<span class="screen-reader-text">Vēsture</span>
										</p>
									</div>
									<!-- MAIN IMAGE : end -->
														...
														<div class="post__inner">
															...
															<header class="main-header">
																<div class="main-header__inner">
																		...
																		<div class="breadcrumbs__inner">
																			...
																			<nav class="breadcrumbs__nav" aria-label="Breadcrumbs">
																				<ul class="breadcrumbs__list">
																					...
																					<li class="breadcrumbs__item">
																						<span class="breadcrumbs__item-decor" aria-hidden="true"></span>
																						<a href="blog-archive.html" class="breadcrumbs__link">Tautasnams</a>
																					</li>
																	...
																	<h1 class="main-header__title">Vēsture</h1>
