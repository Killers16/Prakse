...
<html lang="en-US">
	<head>
        ...
        <title>Listing Archive | Wordbench - Municipality HTML Template</title>
														...
														<nav class="post-archive-categories" title="Categories">
															...
															<ul class="post-archive-categories__list">
																...
																<li class="post-archive-categories__item post-archive-categories__item--all">
																	<a href="listing-archive.html" class="post-archive-categories__item-link post-archive-categories__item-link--active">All</a>
																</li>

																<li class="post-archive-categories__item post-archive-categories__item--category">
																	<a href="listing-archive.html" class="post-archive-categories__item-link">Bakeries</a>
																</li>

																<li class="post-archive-categories__item post-archive-categories__item--category">
																	<a href="listing-archive.html" class="post-archive-categories__item-link">Pubs</a>
																</li>

																<li class="post-archive-categories__item post-archive-categories__item--category">
																	<a href="listing-archive.html" class="post-archive-categories__item-link">Restaurants</a>
																</li>
														...
														<article class="post post--has-thumbnail">
															<div class="post__inner">
																...
																<p class="post__thumbnail post__thumbnail--cropped">
																	<a href="listing-detail.html" class="post__thumbnail-link post__thumbnail-link--cropped" style="background-image: url( '<?php echo 'data:image/png;base64,' . $row["picture"] . ''; ?>' );">
																...
																<div class="post__container">
																	...
																	<header class="post__header">
																		...
																		<p class="post__categories" title="Category">
																			<span class="post__terms post__terms--lsvr_listing_cat">
																				<a href="listing-archive.html" class="post__term-link"><?php echo $row["cname"] ?></a>
																			</span>
																		</p>
																		<!-- POST CATEGORIES : end -->
																		...
																		<h2 class="post__title">
																			<a href="places-details.php?id=<?php echo $row["id_activities"] ?>" class="post__title-link" rel="bookmark"><?php echo $row["aname"] ?></a>
																		</h2>
																		<!-- POST TITLE : end -->
																	...
																	<div class="post__content">
																		<p>1610 San Antonio St,<br>Austin, TX 78701</p>
																	</div>
																	<!-- POST CONTENT : end -->

																	<!-- POST PERMALINK : begin -->
																	<p class="post-permalink">
																		<a href="places-details.php?id=<?php echo $row["id_activities"] ?>" class="post-permalink__link" rel="bookmark">
