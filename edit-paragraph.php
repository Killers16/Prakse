...
<form action="">
    <!--SELECT DATABASE DATA -->
                            ...
                            include_once 'database_config.php';
                                $result = mysqli_query($conn,"SELECT * FROM blogs WHERE id=1");
                            ?>
  ...
  <textarea name="content" style="resize: none;" rows="5" cols="30" value="<?php echo $row['content'] ?>"></textarea>

  <label for="author">Raksta autors:</label><br>
  <input type="text" id="author" name="author" value="<?php echo $row['full_name'] ?>"><br><br>
